...
define("nodes/components/driver-example/component", ["exports", "shared/mixins/node-driver"], function (exports, _nodeDriver) {
  "use strict";
  ...
  exports.default = Ember.Component.extend(_nodeDriver.default, {
    driverName: 'example',
    config: alias('model.exampleConfig'),
    app: service(),
    init: function init() {
      var decodedLayout = window.atob(LAYOUT);
      var template = Ember.HTMLBars.compile(decodedLayout, {
        moduleName: 'nodes/components/driver-example/template'
      });
    ...
    bootstrap: function bootstrap() {
      ...
      set(this, 'model.exampleConfig', config);
    },
...
define("ui/components/driver-example/component", ["exports", "nodes/components/driver-example/component"], function (exports, _component) {
  "use strict";
